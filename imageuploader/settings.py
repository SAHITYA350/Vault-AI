...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-1)%#0!z_g@*850)pj0fg7*5n)y=d&6px7fnlieo$i+%!4x19f+')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.getenv('DJANGO_DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ['*'] # Allowed for Render / Vercel
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'myapp.context_processors.profile_context',
            ],
        },
    },
]
...
# Cross-Origin Opener Policy to allow Razorpay checkout popups
SECURE_CROSS_ORIGIN_OPENER_POLICY = 'same-origin-allow-popups'

# Email backend for password reset logs in local development
